...
void Feature::clean_old_measurements(const std::vector<int64_t> &valid_times) {
...
void Feature::clean_invalid_measurements(const std::vector<int64_t> &invalid_times) {
...
void Feature::clean_older_measurements(int64_t timestamp) {
