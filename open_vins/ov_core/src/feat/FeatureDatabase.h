...
public:
   ...
   */
  void update_feature(size_t id, int64_t timestamp, size_t cam_id, float u, float v, float u_n, float v_n);
   ...
   */
  std::vector<std::shared_ptr<Feature>> features_not_containing_newer(int64_t timestamp, bool remove = false, bool skip_deleted = false);
   ...
   */
  std::vector<std::shared_ptr<Feature>> features_containing_older(int64_t timestamp, bool remove = false, bool skip_deleted = false);
   ...
   */
  std::vector<std::shared_ptr<Feature>> features_containing(int64_t timestamp, bool remove = false, bool skip_deleted = false);
   ...
   */
  void cleanup_measurements(int64_t timestamp);

  /**
   * @brief This function will delete all feature measurements that are at the specified timestamp
   */
  void cleanup_measurements_exact(int64_t timestamp);
